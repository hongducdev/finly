...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `source` TEXT NOT NULL, `type` TEXT NOT NULL, `amount` INTEGER NOT NULL, `balance` INTEGER, `timestamp` INTEGER NOT NULL, `rawText` TEXT NOT NULL, `rawTextHash` TEXT NOT NULL, `description` TEXT, `category` TEXT)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '4923d44b8db164c970ff10bf66369b2c')");
      }
    ...
    }, "4923d44b8db164c970ff10bf66369b2c", "6e59bf80e7668523a8039a925ae5982b");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "transactions","budgets","savings_goals");
  }
